...
exports.addAudioFile = async (req, res) => {
  try {
    ...
    fs.writeFileSync(file.originalFilename, fs.readFileSync(file.filepath));

    const data = new FormData();
    const blob = new Blob(
      [
        JSON.stringify({
          key_content_id: uuidv4(),
    ...
    data.append("audioFile", fs.createReadStream(file.originalFilename));
